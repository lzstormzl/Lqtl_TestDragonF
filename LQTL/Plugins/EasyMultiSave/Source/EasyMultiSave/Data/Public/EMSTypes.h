...
namespace EMS
{
	...
	constexpr double ShortDelay = 0.1f;
...
{
	/** Resets properties values and clears memory data. The Custom Save will be reloaded from disk. */
	Full UMETA(DisplayName = "Full Reset"),

	/** Clears only memory data while keeping the current property values intact. The Custom Save will be reloaded from disk. */
