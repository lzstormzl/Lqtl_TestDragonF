...
{
	FSaveGameArchive(FArchive& InInnerArchive, ESaveObjectType Type) : FObjectAndNameAsStringProxyArchive(InInnerArchive, true)
	{
		//Consider only 'Save Game' variables.
		ArIsSaveGame = (Type == ESaveObjectType::SaveGameOnly);
