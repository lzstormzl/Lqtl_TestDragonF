...
public:
	...
	/**
	* Required when migrating older save files to a new engine build.
	* Select the minimum Unreal Engine version that the old files were created with.
	*/
	...
	/**
	* Enable this when migrating older files with Multi-Level Saving. 
