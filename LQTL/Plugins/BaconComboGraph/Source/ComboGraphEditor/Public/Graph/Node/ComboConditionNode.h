...
#include "ComboConditionNode.generated.h"

class UComboConditionNodeData;

UCLASS()
class COMBOGRAPHEDITOR_API UComboConditionNode : public UComboNodeBase
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	UComboConditionNodeData* NodeInfo; 
};
