...
#include "ComboExecutionNode.generated.h"

class UComboExecutionNodeData;

UCLASS()
class COMBOGRAPHEDITOR_API UComboExecutionNode : public UComboNodeBase
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	UComboExecutionNodeData* NodeInfo;
};