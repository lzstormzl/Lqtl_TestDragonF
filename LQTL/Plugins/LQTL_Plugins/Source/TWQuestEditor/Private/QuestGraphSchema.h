...
/** Action thêm 1 node vào Graph */
USTRUCT()
struct TWQUESTEDITOR_API FQuestSchemaAction_NewNode : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();

	/** Template node quest thêm vào Graph */
	UPROPERTY()
...
/** Action thêm 1 Comment node vào Graph */
USTRUCT()
