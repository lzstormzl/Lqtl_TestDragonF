...
UObject* UQuestAssetFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn, FName CallingContext)
{
	...
	// Tìm class Quest từ settings, nếu không tìm thấy thì set về UQuest mặc định
	...
	// Nếu null thì set lại về UQuest cho chắc
	...
	// Tạo Blueprint mới
	QuestBP = CastChecked<UQuestBlueprint>(FKismetEditorUtilities::CreateBlueprint(
		QuestClass, 
		InParent, 
		Name, 
		BPTYPE_Normal, 
