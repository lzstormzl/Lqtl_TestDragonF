...
class TWQUESTEDITOR_API FQuestBlueprintCompiler : public IBlueprintCompiler
{
 ...
 */
class TWQUESTEDITOR_API FQuestBlueprintCompilerContext : public FKismetCompilerContext
{
public:
