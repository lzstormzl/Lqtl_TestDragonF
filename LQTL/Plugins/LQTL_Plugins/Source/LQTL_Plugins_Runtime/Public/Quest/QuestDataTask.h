...
#include "QuestDataTask.generated.h"
...
class LQTL_PLUGINS_RUNTIME_API UQuestDataTask : public UDataAsset
{
	GENERATED_BODY()

public:

	UQuestDataTask(const FObjectInitializer& ObjectInitializer);
