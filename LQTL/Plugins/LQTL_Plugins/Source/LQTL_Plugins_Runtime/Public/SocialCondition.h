...
#include "SocialCondition.generated.h"
 ...
 */
UCLASS(Abstract, Blueprintable, EditInlineNew, AutoExpandCategories = ("TaleWeavers"))
class LQTL_PLUGINS_RUNTIME_API USocialCondition : public UObject
{
	GENERATED_BODY()
...
public:
	...
	bool CheckCondition(APawn* Pawn, APlayerController* Controller, class USocialComponent* SocialComponent);
	virtual bool CheckCondition_Implementation(APawn* Pawn, APlayerController* Controller, class USocialComponent* SocialComponent);
