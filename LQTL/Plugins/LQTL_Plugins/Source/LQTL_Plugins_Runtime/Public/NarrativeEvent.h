...
class LQTL_PLUGINS_RUNTIME_API UNarrativeEvent : public UObject
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	bool ExecuteEvent(APawn* Pawn, APlayerController* Controller, class USocialComponent* SocialComponent);
	virtual bool ExecuteEvent_Implementation(APawn* Pawn, APlayerController* Controller, class USocialComponent* SocialComponent);
