#include "Quest/QuestDataTask.h"

#define LOCTEXT_NAMESPACE "QuestTask"

UQuestDataTask::UQuestDataTask(const FObjectInitializer& ObjectInitializer)
{
...
FString UQuestDataTask::MakeTaskString(const FString& Argument) const
{
...
FText UQuestDataTask::GetReferenceDisplayText()
{
