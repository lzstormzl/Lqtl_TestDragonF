...
void USMGraphNode_AnyStateNode::SetNodeName_Direct(const FString& InNewName)
{
	NodeName = FText::FromString(InNewName);
}

UClass* USMGraphNode_AnyStateNode::GetNodeClass() const
{
	return USMAnyStateInstance::StaticClass();
}
