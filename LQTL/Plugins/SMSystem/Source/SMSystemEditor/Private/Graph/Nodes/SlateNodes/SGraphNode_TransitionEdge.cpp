...
void SGraphNode_TransitionEdge::MoveTo(const FVector2f& NewPosition, FNodeSet& NodeFilter, bool bMarkDirty)
{
...
FVector2f SGraphNode_TransitionEdge::GetTotalRerouteSpacerSize()
{
