...
void USMGraphNode_Base::PreCompile(FSMKismetCompilerContext& CompilerContext)
{
	...
	SetReadOnlyNodePosition(FVector2f(NodePosX, NodePosY));
...
void USMGraphNode_Base::OnNodeMoved(const FVector2f& NewPosition)
{
...
void USMGraphNode_Base::SetReadOnlyNodePosition(const FVector2f& Position)
{
	NodePosition = FVector2D(Position);
}
