...
UEdGraphNode* FSMGraphSchemaAction_NewComment::PerformAction(class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2f& Location, bool bSelectNewNode /*= true*/)
{
...
UEdGraphNode* FSMGraphSchemaAction_NewNode::PerformAction(class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2f& Location, bool bSelectNewNode /*= true*/)
{
	...
	const FVector2f& GraphPosition) const
{
	...
	const FVector2f NodeSpacerSize = SGraphNode_TransitionEdge::GetTotalRerouteSpacerSize();
	const FVector2f KnotTopLeft = GraphPosition - (NodeSpacerSize / 2.f);
