...
#include "Nodes/FunctionNodes/SMGraphK2Node_FunctionNodes_TransitionInstance.h"
#include "Nodes/FunctionNodes/SMGraphK2Node_StateWriteNodes.h"
...
FSMNode_Base* USMTransitionGraph::GetRuntimeNode() const
{
