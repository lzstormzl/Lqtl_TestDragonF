...
FSMBlueprintEditorModeBase::FSMBlueprintEditorModeBase(TSharedPtr<FSMStateMachineBlueprintEditor> EditorIn, FName EditorModeIn) :
...
FSMBlueprintEditorGraphMode::FSMBlueprintEditorGraphMode(TSharedPtr<class FSMStateMachineBlueprintEditor> EditorIn)
...
FSMBlueprintEditorPreviewMode::FSMBlueprintEditorPreviewMode(TSharedPtr<FSMStateMachineBlueprintEditor> EditorIn)
