...
FSMViewSummonerBase::FSMViewSummonerBase(FName InIdentifier, TSharedPtr<FSMStateMachineBlueprintEditor> InHostingApp, TSharedPtr<SWidget> TabWidgetIn) : FWorkflowTabFactory(InIdentifier, InHostingApp)
...
FSMPreviewDefaultsViewSummoner::FSMPreviewDefaultsViewSummoner(TSharedPtr<FSMStateMachineBlueprintEditor> InHostingApp, TSharedPtr<SWidget> TabWidgetIn) :
...
FSMPreviewViewportViewSummoner::FSMPreviewViewportViewSummoner(TSharedPtr<FSMStateMachineBlueprintEditor> InHostingApp, TSharedPtr<SWidget> TabWidgetIn) :
...
FSMPreviewAdvancedDetailsViewSummoner::FSMPreviewAdvancedDetailsViewSummoner(
	TSharedPtr<FSMStateMachineBlueprintEditor> InHostingApp, TSharedPtr<SWidget> TabWidgetIn) : FSMViewSummonerBase(FSMBlueprintEditorPreviewMode::TabID_AdvSceneDetailsView, InHostingApp, TabWidgetIn)
{
