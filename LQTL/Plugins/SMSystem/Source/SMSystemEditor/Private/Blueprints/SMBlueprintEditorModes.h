...
{
public:
	FSMBlueprintEditorModeBase(TSharedPtr<FSMStateMachineBlueprintEditor> EditorIn, FName EditorModeIn);
...
{
public:
	FSMBlueprintEditorGraphMode(TSharedPtr<class FSMStateMachineBlueprintEditor> EditorIn);
...
public:
	FSMBlueprintEditorPreviewMode(TSharedPtr<class FSMStateMachineBlueprintEditor> EditorIn);
	virtual ~FSMBlueprintEditorPreviewMode() override;
