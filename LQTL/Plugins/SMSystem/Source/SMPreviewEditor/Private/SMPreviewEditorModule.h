...
public:
	...
	virtual void DeleteSelection(TWeakPtr<FSMStateMachineBlueprintEditor> InBlueprintEditor) override;
	
	virtual TSharedRef<SWidget> CreatePreviewEditorWidget(TWeakPtr<FSMStateMachineBlueprintEditor> InBlueprintEditor, const FName& InTabID) override;
	virtual TSharedRef<SWidget> CreatePreviewViewportWidget(TWeakPtr<FSMStateMachineBlueprintEditor> InBlueprintEditor) override;
	virtual TSharedRef<SWidget> CreateAdvancedSceneDetailsWidget(TWeakPtr<FSMStateMachineBlueprintEditor> InBlueprintEditor, TSharedPtr<SWidget> InViewportWidget) override;
	// ~ISMPreviewEditorModule
