...
void SSMPreviewModeEditorView::Construct(const FArguments& InArgs, TSharedPtr<FSMStateMachineBlueprintEditor> InStateMachineEditor, const FName& InTabID)
{
...
void SSMPreviewModeEditorView::OnOutlinerSelectionChanged(FSceneOutlinerTreeItemPtr TreeItem, ESelectInfo::Type Type)
{
	...
	FSMStateMachineBlueprintEditor* BPEditor = BlueprintEditor.Pin().Get();
