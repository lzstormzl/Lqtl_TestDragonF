...
public:
	 ...
	 * @todo Deprecate function. We only have a simulated state machine actor now.
	 */
	ASMPreviewStateMachineActor* GetPreviewStateMachineActor() const { return SimulatedStateMachineActor; }
	...
	// @TODO preview: deprecate Set/Get SimulatedStateMachines. These aren't used any more.
