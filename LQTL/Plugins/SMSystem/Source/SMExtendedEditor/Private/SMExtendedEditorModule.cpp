...
void FSMExtendedEditorModule::StartupModule()
{
	...
	OnEditorCommandsCreatedHandle = FSMStateMachineBlueprintEditor::OnCreateGraphEditorCommandsEvent.AddStatic(&FSMExtendedEditorCommands::OnEditorCommandsCreated);
...
void FSMExtendedEditorModule::ShutdownModule()
{
	...
	FSMStateMachineBlueprintEditor::OnCreateGraphEditorCommandsEvent.Remove(OnEditorCommandsCreatedHandle);
