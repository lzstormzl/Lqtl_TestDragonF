...
public:
	...
	/** @deprecated Use FSMStateMachine::IsStateMachineInEndState() instead. */
	UE_DEPRECATED(5.1, "This function is deprecated. Use FSMStateMachine::IsStateMachineInEndState().")
