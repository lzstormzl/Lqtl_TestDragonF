...
public:
	 ...
	 * This can be used if you programmatically update an exposed property outside of editor construction scripts
	 * such as through PostEditChangeProperty and want that value reflected on the node.
	 *
	 * @warning This should **NOT** be called during editor construction scripts as they will automatically refresh property pins.
	 */
	 ...
	 * blueprint pin.
	 *
	 * @warning This should **NOT** be called during editor construction scripts as they will automatically refresh property values.
	 */
