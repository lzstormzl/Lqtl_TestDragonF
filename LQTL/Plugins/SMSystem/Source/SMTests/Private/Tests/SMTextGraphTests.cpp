 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyBlueprintVariableTest, "LogicDriver.TextGraphProperty.BlueprintVariableFormat",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FSMTextGraphPropertyBlueprintVariableTest::RunTest(const FString& Parameters)
{
...
/**
 * Test text graph properties and make sure they format native variables correctly.
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyNativeVariableTest, "LogicDriver.TextGraphProperty.NativeVariableFormat",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FSMTextGraphPropertyNativeVariableTest::RunTest(const FString& Parameters)
{
	FAssetHandler NewAsset;
	if (!TestHelpers::TryCreateNewStateMachineAsset(this, NewAsset, false, USMTestDialogueInstance::StaticClass()))
	{
		return false;
	}
	...
	// Used for extracting expected values.
	USMTestDialogueInstance* DummyInstance = NewObject<USMTestDialogueInstance>();
	
	FText NewText = FText::FromString(FString::Printf(TEXT("Native property: {%s}, native function: {%s}."),
		GET_MEMBER_NAME_STRING_CHECKED(USMTestDialogueInstance, TextVar), GET_FUNCTION_NAME_STRING_CHECKED(USMTestDialogueInstance, GetTextFunction)));
	FText ExpectedText = FText::FromString(FString::Printf(TEXT("Native property: %s, native function: %s."),
		*DummyInstance->TextVar.ToString(), *DummyInstance->GetTextFunction().ToString()));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyVariableInReferenceTest, "LogicDriver.TextGraphProperty.VariableFormatInReference",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphRichStyleTest, "LogicDriver.TextGraphProperty.RichStyle",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyArrayTest, "LogicDriver.TextGraphProperty.Array",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
	...
	FText* SetInstanceText = nullptr, bool bRestoreOldValue = true)
{
	...
	USMTextGraphState* CDO = CastChecked<USMTextGraphState>(NodeBP->GeneratedClass->GetDefaultObject(false));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyLocalizationStringTest, "LogicDriver.TextGraphProperty.Localization.Propagation.String",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FSMTextGraphPropertyLocalizationStringTest::RunTest(const FString& Parameters)
{
	auto TestBody = [&]() -> bool
	{
		...
		const FText NewCDOText = FText::AsCultureInvariant(FText::FromString("New defaults"));
		...
		{
			FText InstanceText = FText::AsCultureInvariant(FText::FromString("New instance defaults"));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyLocalizationNamespaceTest, "LogicDriver.TextGraphProperty.Localization.Propagation.Namespace",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyLocalizationKeyTest, "LogicDriver.TextGraphProperty.Localization.Propagation.Key",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyLocalizationInvariantTest, "LogicDriver.TextGraphProperty.Localization.Propagation.Invariant",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FSMTextGraphPropertyLocalizationInvariantTest::RunTest(const FString& Parameters)
{
	auto TestBody = [&]() -> bool
	{
		...
		// Change string
		{
			const FText NewCDOText = FText::AsCultureInvariant(FText::FromString("Test"));
			const bool bShouldMatch = true;
			TestLocalizationPropagation(this, NewBP, NodeBP, NewCDOText, bShouldMatch);
		}
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSMTextGraphPropertyLocalizationStableKeyTest, "LogicDriver.TextGraphProperty.Localization.StableKey",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FSMTextGraphPropertyLocalizationStableKeyTest::RunTest(const FString& Parameters)
{
	auto TestBody = [&]() -> bool
	{
		...
		auto ValidateTextMatches = [&](const FText& CurrentText, const FText& NewText, bool bExpectDifferentKey = false)
		{
			...
			{
				TestNotEqual("Different key set", *CurrentKey, ExpectedKey);
			}
			else
			{
...
#define INITIAL_KEY "initial_key"
	...
	// Legacy construction scripts no longer work well with stable keys. We now warn this isn't supported and simply test here
	// to make sure it fails.
	{
		AddExpectedError("Different key set", EAutomationExpectedErrorFlags::Contains, 1);
		AddExpectedError("Key set", EAutomationExpectedErrorFlags::Contains, 2);
		AddExpectedError("Stable localization keys may not work properly", EAutomationExpectedErrorFlags::Contains, 2);
		Settings->EditorNodeConstructionScriptSetting = ESMEditorConstructionScriptProjectSetting::SM_Legacy;
		TestBody();
	}
