 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAsyncCreateInstanceTest, "LogicDriver.Async.CreateInstance",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAsyncInitializeWaitTest, "LogicDriver.Async.InitializeWait",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAsyncNodeEditorThreadSafeTest, "LogicDriver.Async.EditorThreadSafeCheck",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FAsyncNodeEditorThreadSafeTest::RunTest(const FString& Parameters)
{
	...
	const USMNodeInstance* NodeInstance = CastChecked<USMNodeInstance>(NodeBlueprint->GeneratedClass->GetDefaultObject(false));
